...
class FeatureMapper:
    ...
    def crop_img(self, original_roi_path, original_img_path, store_key=''):
        ...
        sitk.WriteImage(cropped_roi, os.path.join(self.store_path, store_key + '_cropped_mask.nii.gz'))
...
def main():
    ...
    img_path = cur_file_path / 'data' / '092.nrrd'
    roi_path = cur_file_path / 'data' / '092_mask.nii.gz'

    store_path = cur_file_path / 'data' / 'FeatureMap'
    ...
    cropped_img_path = cur_file_path / 'data' / 'FeatureMap' / 'original_cropped_img.nii.gz'
    cropped_roi_path = cur_file_path / 'data' / 'FeatureMap' / 'original_cropped_roi.nii.gz'
    feature_name = 'original_glszm_SizeZoneNonUniformityNormalized'
    feature_map = cur_file_path / 'data' / 'FeatureMap' / str(feature_name+'.nrrd')
    fig_save_path = cur_file_path / 'data' / 'FeatureMap' / feature_name
